...
const teamMembers = [
  ...
  },
  {
    ...
    tagline: 'The Digital Growth Engine',
    img: '/uploads/Rahul.jpeg',
    intro:
      'Rahul Upadhyay architects the entire digital presence of EUS Realty — from lead generation funnels and SEO strategy to the technology stack powering this very platform. His campaigns have driven thousands of qualified inquiries and his systems ensure no client opportunity is ever missed. He is the engine behind the brand.',
    expertise: ['Digital Marketing', 'Lead Generation', 'PropTech Systems', 'Brand Strategy'],
    accolade: '5,000+ Monthly Qualified Leads',
    wa: '917620733613',
    linkedin: 'https://linkedin.com',
