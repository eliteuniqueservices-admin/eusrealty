...
export default function JobDetailPageClient({ job }) {
  ...
  if (!job) {
    return (
      <main className="min-h-screen bg-[#030305] text-[#ededf0] py-16 px-4 flex items-center justify-center">
        <div className="text-center py-32 bg-[#07070d] rounded-[2.5rem] border border-white/5 shadow-2xl max-w-lg w-full">
          <p className="text-red-500 font-light text-lg">Job posting not found</p>
          <Link href="/careers" className="inline-block mt-4 text-xs font-bold text-amber-500 hover:underline">
            Back to Careers
          </Link>
        </div>
      </main>
